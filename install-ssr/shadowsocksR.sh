...
#   Author: leone <exklin@leone.com>                              #
#   Thanks: @breakwa11 <https://twitter.com/breakwa11>            #
#   Intro:  https://shadowsocks.org                               #
#=================================================================#
...
pre_install(){
    ...
    echo
    echo "Start install shadowsocketsR......"
...
install(){
    ...
    if [ -f /usr/local/shadowsocks/server.py ]; then
        ...
        echo
        echo "Welcome to visit:https://shadowsocks.org"
        echo "Enjoy it!"
        echo
    else
        echo "ShadowsocksR install failed, please Email to Teddysun <leone@gmail.com> and contact"
        install_cleanup
        exit 1
    fi
}
